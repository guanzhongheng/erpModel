...
public class Const {
	...
	public static final String PROD_PREFIX = "p";									//产品编号前缀
	public static final String SEMI_PROD_PREFIX = "sp";								//半产品编号前缀
	public static final String RAW_MT_PREFIX = "rm";								//原材料编号前缀
	public static final String RAW_MT_OUT_PREFIX = "rmo";						    //原材料出库编号前缀
