...
import com.hh.ssm.domain.authority.*;
...
import com.hh.ssm.mapper.authority.SysRoleMapper;
import com.hh.ssm.mapper.authority.SysRolePermissionMapper;
import com.hh.ssm.mapper.authority.SysUserRoleMapper;
import com.hh.ssm.service.RoleService;
...
public class RoleServiceImpl implements RoleService {
	...
	public CustomResult delete(String string) throws Exception{
		...
		sysUserRoleMapper.deleteBatchByRoleId(new String[]{string});
		sysRolePermissionMapper.deleteBatchByRoleId(new String[]{string});
		if(i>0){
	...
	public CustomResult deleteBatch(String[] ids) throws Exception{
		...
		// 删除角色相关权限
		sysUserRoleMapper.deleteBatchByRoleId(ids);
		sysRolePermissionMapper.deleteBatchByRoleId(ids);
		if(i>=0){
			return CustomResult.ok();
		}else{
			return null;
