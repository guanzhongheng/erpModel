...
import com.hh.ssm.domain.authority.SysUserRole;
import com.hh.ssm.domain.authority.SysUserRoleExample;
...
public class UserServiceImpl implements UserService {
	...
	public List<SysUser> findByUserNameAndId(String username, String id) throws Exception{
		...
		List<SysUser> sysUserList = sysUserMapper.find(sysUser);
		return sysUserList;
	}
	...
	public CustomResult delete(String id) throws Exception{
		...
		sysUserRoleMapper.deleteBatchByUserId(new String[]{id});
		if(i>0){
	...
	public CustomResult updateAll(SysUser userPO) throws Exception{
		...
		userPO.setDateLoseTime(DateUtil.fomatDate(userPO.getLoseTime()));
	...
	public List<SysUser> getList(SysUser user) {
		return sysUserMapper.search(user);
	}
}
