    ...
    <form id="" name="" class="contractForm" method="post">
        <table cellpadding="5">
            <tr>
                <td>合同名称:</td>
                <td>
                    <select id="changeContact" class="easyui-combobox" name="roleId"  panelHeight="auto" data-options="valueField:'id',
	            		textField:'name',url:'contract/validContract?status=1',required:true, editable:false,align:'center',width:90"/>
                </td>
            </tr>
        </table>
    </form>
