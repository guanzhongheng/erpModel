...
<body data-sa-theme="${sessionScope.SKIN}">
	...
	<div class="card-body">
		...
		<form action="inventory/${msg }" name="Form" id="Form" method="post">
			<input type="hidden" name="INVENTORY_ID" id="INVENTORY_ID" value="${pd.INVENTORY_ID}"/>
			<div id="showform">
				<div class="input-group" style="margin-top:3px;">
	                <span class="input-group-addon" style="width: 79px;"><span style="width: 100%;">库存ID</span></span>
	                <div class="form-group">
	                    <input type="number" class="form-control" name="ID" id="ID" value="${pd.ID}" maxlength="32" placeholder="这里输入库存ID" title="库存ID">
				...
				<div class="input-group" style="margin-top:3px;">
	                <span class="input-group-addon" style="width: 79px;"><span style="width: 100%;">库存数</span></span>
	                <div class="form-group">
	                    <input type="number" class="form-control" name="QUANTITY" id="QUANTITY" value="${pd.QUANTITY}" maxlength="32" placeholder="这里输入库存数" title="库存数">
	                    <i class="form-group__bar"></i>
	                </div>
	            </div>
				<div class="input-group" style="margin-top:3px;">
	                <span class="input-group-addon" style="width: 79px;"><span style="width: 100%;">可用库存数</span></span>
	                <div class="form-group">
	                    <input type="number" class="form-control" name="USABLE_QUANTITY" id="USABLE_QUANTITY" value="${pd.USABLE_QUANTITY}" maxlength="32" placeholder="这里输入可用库存数" title="可用库存数">
	                    <i class="form-group__bar"></i>
	                </div>
	            </div>
				<div class="input-group" style="margin-top:3px;">
	                <span class="input-group-addon" style="width: 79px;"><span style="width: 100%;">库存创建时间</span></span>
	                <div class="form-group">
	                    <input type="text" class="form-control date-picker flatpickr-input active" name="CREATE_TIME" id="CREATE_TIME" value="${pd.CREATE_TIME}" maxlength="32" placeholder="这里输入库存创建时间" title="库存创建时间">
	                    <i class="form-group__bar"></i>
	                </div>
	            </div>
				<div class="input-group" style="margin-top:3px;">
	                <span class="input-group-addon" style="width: 79px;"><span style="width: 100%;">库存更新时间</span></span>
	                <div class="form-group">
	                    <input type="text" class="form-control date-picker flatpickr-input active" name="UPDATE_TIME" id="UPDATE_TIME" value="${pd.UPDATE_TIME}" maxlength="32" placeholder="这里输入库存更新时间" title="库存更新时间">
	                    <i class="form-group__bar"></i>
	                </div>
	            </div>
    ...
    <!-- 表单验证提示 -->
  	...
  	<script type="text/javascript">
		...
		function save(){
			...
			if($("#USABLE_QUANTITY").val()==""){
				$("#USABLE_QUANTITY").tips({
					side:3,
		            msg:'请输入可用库存数',
		            bg:'#AE81FF',
		            time:2
		        });
				$("#USABLE_QUANTITY").focus();
			return false;
			}
			if($("#CREATE_TIME").val()==""){
				$("#CREATE_TIME").tips({
