	...
	<form id="userAddForm" class="userForm" method="post">
	    <table cellpadding="5" >
			...
			<tr>
				<td>用户工号:</td>
				<td>
					<input id="userNumber" class="easyui-textbox" type="text" name="userNumber"
						   data-options="required:true"/>
				</td>
			</tr>
			<tr>
	        ...
	        <tr>
	            <td>用户状态:</td>
	            <td>
		            <select class="easyui-combobox" name="status" panelHeight="auto" data-options="width:150,
		            		editable:false">
						<option value="0">有效用户</option>
