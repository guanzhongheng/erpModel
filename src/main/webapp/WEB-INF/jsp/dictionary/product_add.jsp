	...
	<form id="productAddForm" class="productForm" method="post">
	    <table cellpadding="5" >
			...
			<tr>
				<td>产品类型:</td>
				<td>
					<select class="easyui-combobox" name="type" panelHeight="auto" data-options="width:150,
		            		editable:false">
		...
		<table class="easyui-datagrid" id="semiProdList" name="semiProdList" title="半产品管理" border="true" fitColumns="true"
			   pagination="true" rownumbers="true" singleSelect="true" collapsible="true" toolbar="#prodAddDatagridToolbar"
			   data-options="">
			<thead>
			<tr>
...
<script type="text/javascript">
	...
	function submitProductAddForm(){
        ...
        var data = {};
        data =  getFormData($("#productAddForm"));
