...
<body data-sa-theme="${sessionScope.SKIN}">
	...
	<div class="card-body">
		...
		<form action="warehourseentry/${msg }" name="Form" id="Form" method="post">
			<input type="hidden" name="WAREHOURSEENTRY_ID" id="WAREHOURSEENTRY_ID" value="${pd.WAREHOURSEENTRY_ID}"/>
			<div id="showform">
				<div class="input-group" style="margin-top:3px;">
	                <span class="input-group-addon" style="width: 79px;"><span style="width: 100%;">入库单ID</span></span>
	                <div class="form-group">
	                    <input type="number" class="form-control" name="ID" id="ID" value="${pd.ID}" maxlength="32" placeholder="这里输入入库单ID" title="入库单ID">
				...
				<div class="input-group" style="margin-top:3px;">
	                <span class="input-group-addon" style="width: 79px;"><span style="width: 100%;">供应商（仅在产品类型为原材料时才存在）</span></span>
	                <div class="form-group">
	                    <input type="text" class="form-control" name="SUPPLIER" id="SUPPLIER" value="${pd.SUPPLIER}" maxlength="64" placeholder="这里输入供应商（仅在产品类型为原材料时才存在）" title="供应商（仅在产品类型为原材料时才存在）">
	                    <i class="form-group__bar"></i>
	                </div>
	            </div>
				<div class="input-group" style="margin-top:3px;">
				...
				<div class="input-group" style="margin-top:3px;">
	                <span class="input-group-addon" style="width: 79px;"><span style="width: 100%;">入库数量</span></span>
	                <div class="form-group">
	                    <input type="number" class="form-control" name="QUANTITY" id="QUANTITY" value="${pd.QUANTITY}" maxlength="32" placeholder="这里输入入库数量" title="入库数量">
	                    <i class="form-group__bar"></i>
	                </div>
	            </div>
				<div class="input-group" style="margin-top:3px;">
	                <span class="input-group-addon" style="width: 79px;"><span style="width: 100%;">入库人</span></span>
	                <div class="form-group">
	                    <input type="text" class="form-control" name="CREATE_USER" id="CREATE_USER" value="${pd.CREATE_USER}" maxlength="64" placeholder="这里输入入库人" title="入库人">
	                    <i class="form-group__bar"></i>
	                </div>
	            </div>
				<div class="input-group" style="margin-top:3px;">
	                <span class="input-group-addon" style="width: 79px;"><span style="width: 100%;">入库时间</span></span>
	                <div class="form-group">
	                    <input type="text" class="form-control date-picker flatpickr-input active" name="CREATE_TIME" id="CREATE_TIME" value="${pd.CREATE_TIME}" maxlength="32" placeholder="这里输入入库时间" title="入库时间">
	                    <i class="form-group__bar"></i>
	                </div>
	            </div>
